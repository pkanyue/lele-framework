...
public class ServiceApiGenerator extends BaseModelGenerator {
    ...
    private final static String LELE_TEMPLATE = "com/rlax/lele/framework/codegen/module/templates/service_template.jf";
    private final static String JBOOT_TEMPLATE = "io/jboot/codegen/service/service_template.tp";
