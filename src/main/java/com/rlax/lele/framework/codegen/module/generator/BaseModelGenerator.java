...
public class BaseModelGenerator extends com.jfinal.plugin.activerecord.generator.BaseModelGenerator {
    ...
    private final static String LELE_TEMPLATE = "/com/rlax/lele/framework/codegen/module/templates/base_model_template.jf";
    private final static String JBOOT_TEMPLATE = "/io/jboot/codegen/model/base_model_template.tp";
