...
public class ElasticSearchImpl extends BaseSearch {
    ...
    public boolean create(SearchDocument searchDocument) {
        if (!StrUtil.areNotEmpty(searchDocument.getIndex(), searchDocument.getType())) {
        ...
        if (StrUtil.isNotBlank(searchDocument.getId())) {
    ...
    public boolean update(SearchDocument searchDocument) {
        if (!StrUtil.areNotEmpty(searchDocument.getIndex(), searchDocument.getType(), searchDocument.getId())) {
